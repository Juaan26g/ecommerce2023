    ...
    <div class="container-menu py-8">
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="flex">
                    <p class="text-neutral-700">Marca: <a class="underline capitalize hover:text-orange-500"
                            href="">{{ $product->brand->name }}</a></p>
                    <p class="text-neutral-700 mx-6">5 <i class="fas fa-star text-sm text-yellow-400"></i></p>
